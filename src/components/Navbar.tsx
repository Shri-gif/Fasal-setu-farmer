...
import { Sprout, User, ShieldCheck, Database, RefreshCw } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-emerald-100 shadow-xs">
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div 
            title={isLiveConnected ? "Connected to Supabase" : "Using local state fallback"}
          ...
          >
            ...
            <span>{isLiveConnected ? "Supabase Live" : "Local Store"}</span>
          </div>
